...
import com.panosdim.annualleaves.models.FileMetadata
...
fun checkForNewVersion(context: Context) {
    ...
    val backendUrl = "https://apps.dsw.mywire.org/annual-leaves/"
    val url: URL
...
private fun downloadNewVersion(context: Context, downloadUrl: Uri, version: String) {
    ...
    request.setDescription("Downloading new version of Annual Leaves.")
    request.setTitle("New Annual Leaves Version: $version")
    request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED)
    request.setDestinationInExternalPublicDir(
        Environment.DIRECTORY_DOWNLOADS,
        "AnnualLeaves-${version}.apk"
    )
